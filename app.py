...
def install_video():
    ...
    yt = YouTube(url="https://www.youtube.com/watch?v=EGtxv5mWCi0")
    ...
    with tempfile.NamedTemporaryFile(mode="w+b", prefix="yt_", suffix="_video", dir="video_tempfiles/") as temp:
        ...
        return send_file(
            temp.name, as_attachment=True, download_name=f"{iuliia.translate(yt.title, iuliia.TELEGRAM)}_YouTubeInstaller.mp4"
        )
